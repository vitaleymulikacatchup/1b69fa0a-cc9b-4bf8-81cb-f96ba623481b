...
export const metadata: Metadata = {
  title: "Love Restaurant - Fine Dining Excellence",
  description: "Discover Love Restaurant, where passion meets culinary perfection. Reserve your table for an unforgettable fine dining experience.",
  keywords: "fine dining, restaurant, elegant cuisine, reservations",
  metadataBase: new URL("https://loverestaurant.com"),
  alternates: {
    canonical: "https://loverestaurant.com"
  },
  openGraph: {
    title: "Love Restaurant",
    description: "An exquisite culinary journey where passion meets perfection",
    type: "website",
    siteName: "Love Restaurant",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1764778913796-h6kifu62.jpg",
      alt: "Love Restaurant - Fine Dining"
    }]
  },
  twitter: {
    ...
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1764778913796-h6kifu62.jpg"]
  },
  robots: {
    index: true,
    follow: true
